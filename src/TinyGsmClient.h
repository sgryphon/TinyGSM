...
#elif defined(TINY_GSM_MODEM_SIM7020) || defined(TINY_GSM_MODEM_SIM7030) || \
    defined(TINY_GSM_MODEM_SIM7060)
...
//typedef TinyGsmSim7020::GsmHttpClientSim7020   TinyGsmHttpClient;
